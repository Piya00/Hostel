...
var snowStorm = (function(window, document) {
  ...
  <style type="text/css">
  	body{
  		background-image: url(https://www.pixel4k.com/wp-content/uploads/2018/10/moon-night-sky-tree-stars-dark-4k_1540576005.jpg);
  		display: flex;
  align-items: center;
...
<?php
   ...
   <center>
   	<h1>Update Hostel Data</h1>
 
		

				<form method="POST" action="updatedata.php">
						<!-- rollno is primary key so cannot edit/update roll no.Therefore input type of rollno is hidden -->
						<label>Id:</label>
						...
						<input type="text" name="hid" value="<?php echo $row['hid']; ?>"><br><br>
