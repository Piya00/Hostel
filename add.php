...
<head>
    ...
    <style type="text/css">
        ...
        h1 {
            font-size: 20px;
            text-align: center;
            font-family: 'Arial', sans-serif; /* Specify a valid font family here */
        }
...
<body>
    <form action="addtodatabace.php" method="POST">
        <h1>Add New Hostel Members</h1>
        ...
        <input type="Number"  name="hid" required>
